...
type controllerRunOptions struct {
	...
	prometheusScrapeConfigMapPrefix string
	ccmMigration                    bool
}
...
func main() {
	...
	flag.StringVar(&runOp.prometheusScrapeConfigMapPrefix, "prometheus-scrape-configmap-prefix", "prometheus-custom-scrape-configs", fmt.Sprintf("The name prefix of ConfigMaps in namespace %s, which will be used to add customized scrape configs for user cluster Prometheus.", resources.UserClusterMLANamespace))
	...
	if err := usercluster.Add(mgr,
		...
		usercluster.UserClusterMLA{
			...
			PrometheusCustomScrapeConfigMapPrefix: runOp.prometheusScrapeConfigMapPrefix,
		},
		log,
	); err != nil {
