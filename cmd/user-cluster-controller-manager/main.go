...
func main() {
	...
	flag.BoolVar(&runOp.kubeLBDisableGatewayAPIProtection, "kubelb-disable-gateway-api-protection", false, "Do not deploy the ValidatingAdmissionPolicy that reserves the Gateway API CRDs for the kubeLB CCM")
