...
func setupControllers(ctrlCtx *controllerContext) error {
	...
	if err := kyvernocontroller.Add(ctrlCtx.mgr, ctrlCtx.log, ctrlCtx.runOptions.workerCount, ctrlCtx.runOptions.workerName, ctrlCtx.clientProvider, ctrlCtx.versions); err != nil {
