...
import (
	...
	applicationdefinitionsynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/application-definition-synchronizer"
	...
	clustertemplatesynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/cluster-template-synchronizer"
	externalcluster "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/external-cluster"
	kcstatuscontroller "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/kc-status-controller"
	"k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/kubeone"
	masterconstraintsynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/master-constraint-controller"
	masterconstrainttemplatecontroller "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/master-constraint-template-controller"
	presetsynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/preset-synchronizer"
	projectlabelsynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/project-label-synchronizer"
	projectsynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/project-synchronizer"
	"k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/rbac"
	seedproxy "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/seed-proxy"
	seedstatuscontroller "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/seed-status-controller"
	seedsync "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/seed-sync"
	serviceaccount "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/serviceaccount-projectbinding-controller"
	userprojectbinding "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/user-project-binding"
	userprojectbindingsynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/user-project-binding-synchronizer"
	usersynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/user-synchronizer"
	usersshkeyprojectownershipcontroller "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/usersshkey-project-ownership"
	usersshkeysynchronizer "k8c.io/kubermatic/v3/pkg/controller/master-controller-manager/usersshkey-synchronizer"
