...
import (
	...
	kcpusercontroller "k8c.io/kubermatic/v2/pkg/ee/kcp-user-controller"
...
func setupControllers(ctrlCtx *controllerContext) error {
	...
	if err := kcpusercontroller.Add(ctrlCtx.mgr, ctrlCtx.log, 1, ctrlCtx.configGetter); err != nil {
		return fmt.Errorf("failed to create KCP user controller: %w", err)
	}
