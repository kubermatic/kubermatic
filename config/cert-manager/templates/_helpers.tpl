...
{{- if .Values.certManager.serviceAccount.create -}}
    {{ default (include "cert-manager.fullname" .) .Values.certManager.serviceAccount.name }}
{{- else -}}
    {{ default "default" .Values.certManager.serviceAccount.name }}
{{- end -}}
{{- end -}}
