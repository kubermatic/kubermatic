...
CONTAINERIZE_IMAGE=quay.io/kubermatic/build:go-1.21-node-18-11 containerize ./hack/update-codegen.sh
...
locationMap='{
  ...
  "clusterbackupstoragelocations.kubermatic.k8c.io": "seed",
