...
# Gather the logs of all user cluster control planes and the Kubermatic namespace.
...
echodate "Running Kyverno integration tests..."

go_test kyverno_e2e -count=1 -timeout 1h -tags e2e,ee -v ./pkg/test/e2e/kyverno \
