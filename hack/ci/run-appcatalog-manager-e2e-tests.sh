...
export KUBERMATIC_YAML=hack/ci/testdata/kubermatic_application_catalog-external.yaml
...
echodate "Running Application Catalog Manager E2E tests..."

go_test appcatalog_manager_e2e -timeout 1h -tags e2e -v ./pkg/test/e2e/appcatalogmanager/... -kubermatic-configuration-name=e2e

echodate "Application Catalog Manager E2E tests done."
