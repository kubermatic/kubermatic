...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentSSHKeys) DeepCopyInto(out *DeploymentSSHKeys) {
	*out = *in
	if in.UserSSHKey != nil {
		in, out := &in.UserSSHKey, &out.UserSSHKey
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentSSHKeys.
func (in *DeploymentSSHKeys) DeepCopy() *DeploymentSSHKeys {
	if in == nil {
		return nil
	}
	out := new(DeploymentSSHKeys)
	in.DeepCopyInto(out)
	return out
}
