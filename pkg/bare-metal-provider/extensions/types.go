...
func (n *Node) GetObjectKind() schema.ObjectKind {
	return &n.TypeMeta
}

//GetObjectMeta returns the object metadata
func (n *Node) GetObjectMeta() metav1.Object {
	return &n.Metadata
}

//GetObjectKind returns the object typemeta information
func (nl *NodeList) GetObjectKind() schema.ObjectKind {
	return &nl.TypeMeta
}

//GetListMeta returns the list object metadata
func (nl *NodeList) GetListMeta() metav1.List {
	return &nl.Metadata
}

//GetObjectKind returns the object typemeta information
func (n *Cluster) GetObjectKind() schema.ObjectKind {
	return &n.TypeMeta
}

//GetObjectMeta returns the object metadata
func (n *Cluster) GetObjectMeta() metav1.Object {
	return &n.Metadata
}

//GetObjectKind returns the object typemeta information
func (nl *ClusterList) GetObjectKind() schema.ObjectKind {
	return &nl.TypeMeta
}

//GetListMeta returns the list object metadata
func (nl *ClusterList) GetListMeta() metav1.List {
	return &nl.Metadata
}
