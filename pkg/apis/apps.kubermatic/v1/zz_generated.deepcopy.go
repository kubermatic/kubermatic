...
func (in *ApplicationTemplate) DeepCopyInto(out *ApplicationTemplate) {
	*out = *in
	...
	if in.TemplateCredentials != nil {
		in, out := &in.TemplateCredentials, &out.TemplateCredentials
		*out = new(TemplateCredentials)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateCredentials) DeepCopyInto(out *TemplateCredentials) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateCredentials.
func (in *TemplateCredentials) DeepCopy() *TemplateCredentials {
	if in == nil {
		return nil
	}
	out := new(TemplateCredentials)
