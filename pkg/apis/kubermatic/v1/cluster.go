...
type ClusterSpec struct {
	...
	// Optional: CNIPluginSettings contains the spec of the CNI plugin used by the Cluster.
	...
	// Optional: OIDCSettings contains OIDC configuration parameters for enabling authentication mechanism for the cluster.
