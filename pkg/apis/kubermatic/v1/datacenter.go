...
type DatacenterSpecOpenstack struct {
	...
	// Optional: DisableSecurityGroup is a flag that determines whether KKP should create the default NodePort security group for the cluster open to 0.0.0.0/0. If set, users need to handle Security Groups by themselves.
	DisableSecurityGroup bool `json:"defaultSecurityGroups,omitempty"`
}
