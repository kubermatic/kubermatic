...
const (
	...
	// TestFakeToken signed JWT token with fake data. It will expire after 3 years from 12-03-2022. To generate new token use kubermatic/pkg/serviceaccount/jwt_test.go
