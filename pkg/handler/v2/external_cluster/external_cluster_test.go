...
func TestCreateClusterEndpoint(t *testing.T) {
	...
	testcases := []struct {
		...
		// scenario 1
		{
			...
			ExpectedResponse:       `{"id":"%s","name":"test","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"isImported":"true","project-id":"my-first-project-ID"},"spec":{},"cloud":{},"status":{"state":"Provisioning"}}`,
		...
		// scenario 5
		{
			...
			ExpectedResponse:       `{"id":"%s","name":"test","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"isImported":"true","project-id":"my-first-project-ID"},"spec":{},"cloud":{"gke":{"name":"gke-cluster","zone":"abc"}},"status":{"state":"Provisioning"}}`,
			RewriteClusterID:       true,
			HTTPStatus:             http.StatusCreated,
			ProjectToSync:          test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(),
		...
		},
		{
			...
			ExpectedResponse:       `{"id":"%s","name":"test","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"isImported":"true","project-id":"my-first-project-ID"},"spec":{},"cloud":{"eks":{"name":"eks-cluster","region":"abc"}},"status":{"state":"Provisioning"}}`,
			RewriteClusterID:       true,
			HTTPStatus:             http.StatusCreated,
			ProjectToSync:          test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(),
