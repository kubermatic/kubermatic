...
func TestCreateClusterEndpoint(t *testing.T) {
	...
	testcases := []struct {
		...
		// scenario 1
		{
			...
			ExpectedResponse:       `{"id":"%s","name":"test","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"project-id":"my-first-project-ID"},"spec":{"version":""},"status":{"state":"","statusMessage":""}}`,
		...
		// scenario 5
		{
			...
			ExpectedResponse:       `{"id":"%s","name":"test","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"project-id":"my-first-project-ID"},"spec":{"version":""},"cloud":{"gke":{"name":"gke-cluster","zone":"abc"}},"status":{"state":"","statusMessage":""}}`,
			RewriteClusterID:       true,
			HTTPStatus:             http.StatusCreated,
			ProjectToSync:          test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(),
		...
		},
		{
			...
			ExpectedResponse:       `{"id":"%s","name":"test","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"project-id":"my-first-project-ID"},"spec":{"version":""},"cloud":{"eks":{"name":"eks-cluster","accessKeyID":"","secretAccessKey":"","region":"abc"}},"status":{"state":"","statusMessage":""}}`,
			RewriteClusterID:       true,
			HTTPStatus:             http.StatusCreated,
			ProjectToSync:          test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(),
...
func TestGetClusterEndpoint(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			ExpectedResponse:       `{"id":"clusterAbcID","name":"clusterAbcID","creationTimestamp":"0001-01-01T00:00:00Z","labels":{"project-id":"my-first-project-ID"},"spec":{"version":"1.22.4"},"status":{"state":"","statusMessage":""}}`,
			HTTPStatus:             http.StatusOK,
			ProjectToSync:          test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(genExternalCluster(test.GenDefaultProject().Name, "clusterAbcID")),
			ClusterToSync:          "clusterAbcID",
