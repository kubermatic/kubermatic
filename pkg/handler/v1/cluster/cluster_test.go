...
func TestGetClusterHealth(t *testing.T) {
	...
	testcases := []struct {
		...
		// scenario 5
		{
			...
			Body:             ``,
			ExpectedResponse: `{"apiserver":1,"scheduler":0,"controller":1,"machineController":0,"etcd":1,"cloudProviderInfrastructure":1,"userClusterControllerManager":1,"userClusterMlaMonitoring":1}`,
			HTTPStatus:       http.StatusOK,
			ClusterToGet:     "keen-snyder",
			ProjectToSync:    test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(
				...
				func() *kubermaticv1.Cluster {
					...
					cluster.Status.ExtendedHealth = kubermaticv1.ExtendedClusterHealth{
						...
						CloudProviderInfrastructure:  kubermaticv1.HealthStatusUp,
						UserClusterControllerManager: kubermaticv1.HealthStatusUp,
						UserClusterMLAMonitoring:     kubermaticv1.HealthStatusUp,
					}
		...
		// scenario 6
		{
			...
			Body:             ``,
			ExpectedResponse: `{"apiserver":1,"scheduler":0,"controller":1,"machineController":0,"etcd":1,"cloudProviderInfrastructure":1,"userClusterControllerManager":1,"userClusterMlaLogging":1}`,
			HTTPStatus:       http.StatusOK,
			ClusterToGet:     "keen-snyder",
			ProjectToSync:    test.GenDefaultProject().Name,
			ExistingKubermaticObjs: test.GenDefaultKubermaticObjects(
				...
				func() *kubermaticv1.Cluster {
					...
					cluster.Status.ExtendedHealth = kubermaticv1.ExtendedClusterHealth{
						...
						CloudProviderInfrastructure:  kubermaticv1.HealthStatusUp,
						UserClusterControllerManager: kubermaticv1.HealthStatusUp,
						UserClusterMLALogging:        kubermaticv1.HealthStatusUp,
					}
