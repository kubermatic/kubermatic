...
func TestGetGlobalSettings(t *testing.T) {
	...
	testcases := []struct {
		...
		// scenario 1
		{
			...
			expectedResponse:       `{"customLinks":[],"cleanupOptions":{"enabled":false,"enforced":false},"defaultNodeCount":10,"displayDemoInfo":false,"displayAPIDocs":false,"displayTermsOfService":false,"enableDashboard":true,"enableOIDCKubeconfig":false,"userProjectsLimit":0,"restrictProjectCreation":false,"enableExternalClusterImport":true,"opaOptions":{"enabled":false,"enforced":false},"mlaOptions":{"loggingEnabled":false,"loggingEnforced":false,"monitoringEnabled":false,"monitoringEnforced":false},"mlaAlertmanagerPrefix":"","mlaGrafanaPrefix":"","machineDeploymentVMResourceQuota":{"minCPU":1,"maxCPU":32,"minRAM":2,"maxRAM":128,"enableGPU":false}}`,
