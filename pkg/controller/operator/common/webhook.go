...
func PolicyBindingValidatingWebhookConfigurationReconciler(ctx context.Context, cfg *kubermaticv1.KubermaticConfiguration, client ctrlruntimeclient.Client) reconciling.NamedValidatingWebhookConfigurationReconcilerFactory {
	return func() (string, reconciling.ValidatingWebhookConfigurationReconciler) {
		return PolicyBindingAdmissionWebhookName, func(hook *admissionregistrationv1.ValidatingWebhookConfiguration) (*admissionregistrationv1.ValidatingWebhookConfiguration, error) {
			matchPolicy := admissionregistrationv1.Exact
			failurePolicy := admissionregistrationv1.Fail
			sideEffects := admissionregistrationv1.SideEffectClassNone
			scope := admissionregistrationv1.ClusterScope
			...
			hook.Webhooks = []admissionregistrationv1.ValidatingWebhook{
				{
					Name:                    "policybindings.kubermatic.k8c.io", // this should be a FQDN
					AdmissionReviewVersions: []string{admissionregistrationv1.SchemeGroupVersion.Version, admissionregistrationv1beta1.SchemeGroupVersion.Version},
					MatchPolicy:             &matchPolicy,
					FailurePolicy:           &failurePolicy,
					SideEffects:             &sideEffects,
					...
					ClientConfig: admissionregistrationv1.WebhookClientConfig{
						...
						Service: &admissionregistrationv1.ServiceReference{
							Name:      WebhookServiceName,
							Namespace: cfg.Namespace,
							Path:      ptr.To("/validate-kubermatic-k8c-io-v1-policybinding"),
							Port:      ptr.To[int32](443),
						},
					},
					ObjectSelector:    &metav1.LabelSelector{},
...
// PolicyTemplateValidatingWebhookConfigurationReconciler returns the ValidatingWebhookConfiguration for PolicyTemplates.
