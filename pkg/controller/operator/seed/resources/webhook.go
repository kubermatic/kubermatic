...
import (
	...
	"k8c.io/kubermatic/v3/pkg/resources/certificates/servingcerthelper"
			...
			r.Rules = []rbacv1.PolicyRule{
				{
					...
					Resources: []string{"clusters", "clustertemplates", "ipamallocations", "externalclusters", "datacenters"},
			...
			hook.Webhooks = []admissionregistrationv1.MutatingWebhook{
				{
					...
					ClientConfig: admissionregistrationv1.WebhookClientConfig{
						...
						Service: &admissionregistrationv1.ServiceReference{
							Name:      WebhookServiceName,
							Namespace: cfg.Namespace,
							Path:      pointer.String("/mutate-application-definition"),
							Port:      pointer.Int32(443),
						},
					},
					Rules: []admissionregistrationv1.RuleWithOperations{
