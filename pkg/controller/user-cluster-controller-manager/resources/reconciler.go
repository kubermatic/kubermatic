...
import (
	...
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/cloudinitsettings"
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/clusterautoscaler"
	controllermanager "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/controller-manager"
	coredns "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/core-dns"
	csimigration "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/csi-migration"
	csisnapshotter "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/csi-snapshotter"
	dnatcontroller "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/dnat-controller"
	...
	kubestatemetrics "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/kube-state-metrics"
	kubernetesresources "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/kubernetes"
	kubernetesdashboard "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/kubernetes-dashboard"
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/kubesystem"
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/machine"
	machinecontroller "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/machine-controller"
	metricsserver "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/metrics-server"
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/mla"
	mlaloggingagent "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/mla/logging-agent"
	mlamonitoringagent "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/mla/monitoring-agent"
	nodelocaldns "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/node-local-dns"
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/openvpn"
	operatingsystemmanager "k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/operating-system-manager"
	"k8c.io/kubermatic/v3/pkg/controller/user-cluster-controller-manager/resources/resources/prometheus"
	...
	osmmigration "k8c.io/kubermatic/v3/pkg/util/migration"
