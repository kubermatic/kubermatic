...
package seedresourcesuptodatecontroller
...
const ControllerName = "kkp-seed-resources-up-to-date-controller"
...
func (r *reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if err != nil {
		r.log.Errorw("Failed to reconcile cluster", "cluster", request.Name, zap.Error(err))
		r.recorder.Eventf(cluster, corev1.EventTypeWarning, "ReconcilingError", "reconciling failed: %v", err)
	}
