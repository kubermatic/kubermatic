...
import (
	...
	"k8c.io/kubermatic/v3/pkg/resources/address"
)

// syncAddress will set the all address relevant fields on the cluster.
func (r *Reconciler) syncAddress(ctx context.Context, log *zap.SugaredLogger, cluster *kubermaticv1.Cluster, config *kubermaticv1.KubermaticConfiguration) error {
	var err error
