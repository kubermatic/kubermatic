...
import (
	...
	"k8c.io/kubermatic/v3/pkg/resources/cloudconfig"
	"k8c.io/kubermatic/v3/pkg/resources/cloudcontroller"
	"k8c.io/kubermatic/v3/pkg/resources/controllermanager"
	"k8c.io/kubermatic/v3/pkg/resources/csi"
	"k8c.io/kubermatic/v3/pkg/resources/dns"
	"k8c.io/kubermatic/v3/pkg/resources/etcd"
	"k8c.io/kubermatic/v3/pkg/resources/konnectivity"
	kubernetesdashboard "k8c.io/kubermatic/v3/pkg/resources/kubernetes-dashboard"
	"k8c.io/kubermatic/v3/pkg/resources/machinecontroller"
	metricsserver "k8c.io/kubermatic/v3/pkg/resources/metrics-server"
	"k8c.io/kubermatic/v3/pkg/resources/nodeportproxy"
	"k8c.io/kubermatic/v3/pkg/resources/openvpn"
	"k8c.io/kubermatic/v3/pkg/resources/operatingsystemmanager"
	"k8c.io/kubermatic/v3/pkg/resources/scheduler"
	"k8c.io/kubermatic/v3/pkg/resources/usercluster"
	userclusterwebhook "k8c.io/kubermatic/v3/pkg/resources/usercluster-webhook"
...
func (r *Reconciler) ensureResourcesAreDeployed(ctx context.Context, cluster *kubermaticv1.Cluster, namespace *corev1.Namespace) (*reconcile.Result, error) {
	...
	data, err := r.getClusterTemplateData(ctx, cluster, config)
	if err != nil {
		return nil, err
	}
	...
	if err := r.syncAddress(ctx, r.log.With("cluster", cluster.Name), cluster, config); err != nil {
...
func (r *Reconciler) getClusterTemplateData(ctx context.Context, cluster *kubermaticv1.Cluster, config *kubermaticv1.KubermaticConfiguration) (*resources.TemplateData, error) {
	datacenter, err := r.datacenterGetter(ctx, cluster.Spec.Cloud.DatacenterName)
	if err != nil {
		return nil, fmt.Errorf("failed to get cluster datacenter: %w", err)
	}
...
func (r *Reconciler) ensureClusterRoleBindings(ctx context.Context, c *kubermaticv1.Cluster, namespace *corev1.Namespace) error {
	namedClusterRoleBindingsReconcilerFactorys := []reconciling.NamedClusterRoleBindingReconcilerFactory{
		...
		etcd.ClusterRoleBindingReconciler(c),
	}
