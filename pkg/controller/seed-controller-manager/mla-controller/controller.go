...
var (
	...
	groupToRole = map[string]grafanasdk.RoleType{
		rbaccontroller.OwnerGroupNamePrefix:  grafanasdk.ROLE_EDITOR, // we assign the editor (not admin) role to project owners, to make sure they cannot edit datasources in Grafana
		rbaccontroller.EditorGroupNamePrefix: grafanasdk.ROLE_EDITOR,
		rbaccontroller.ViewerGroupNamePrefix: grafanasdk.ROLE_VIEWER,
	}
)
