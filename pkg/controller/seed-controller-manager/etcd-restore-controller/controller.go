...
func (r *Reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if err != nil {
		...
		r.recorder.Eventf(restore, corev1.EventTypeWarning, "ReconcilingError", "reconciling failed: %v", err)
		r.recorder.Eventf(cluster, corev1.EventTypeWarning, "ReconcilingError", "failed to reconcile etcd restore %q: %v", restore.Name, err)
	}
