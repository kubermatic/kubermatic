...
const (
	...
	// AuditWebhookSecretName is the name of the secret that contains the audit-webhook-backend configuration mounted into kube-apisever.
	AuditWebhookSecretName = "audit-webhook-backend"
