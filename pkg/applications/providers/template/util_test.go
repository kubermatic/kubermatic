...
func TestRenderValueTemplate(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			values: map[string]any{
				"environment": "{{ index .Cluster.Labels \"environment\" }}",
				"tier":        "{{ index .Cluster.Labels \"tier\" }}",
			},
			templateData: TemplateData{
				Cluster: ClusterData{
		...
		},
		{
			...
			values: map[string]any{
				"description": "{{ index .Cluster.Annotations \"description\" }}",
				"owner":       "{{ index .Cluster.Annotations \"owner\" }}",
			},
			templateData: TemplateData{
				Cluster: ClusterData{
		...
		},
		{
			...
			values: map[string]any{
				"missing": "{{ index .Cluster.Labels \"nonexistent\" }}",
			},
			templateData: TemplateData{
				Cluster: ClusterData{
					Labels: map[string]string{
		...
		},
		{
			...
			values: map[string]any{
				"missing": "{{ index .Cluster.Annotations \"nonexistent\" }}",
			},
			templateData: TemplateData{
				Cluster: ClusterData{
					Annotations: map[string]string{
