...
type ClusterHealth struct {
	...
	UserClusterMLAMonitoring     kubermaticv1.HealthStatus `json:"userClusterMlaMonitoring,omitempty"`
	UserClusterMLALogging        kubermaticv1.HealthStatus `json:"userClusterMlaLogging,omitempty"`
}
