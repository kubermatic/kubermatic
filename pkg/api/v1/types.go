...
type AWSNodeSpec struct {
	...
	// SpotInstanceMaxPrice The maximum price you are willing to pay per instance hour. Your instance runs when
	...
	// For information about Persistent requests and other customization options
