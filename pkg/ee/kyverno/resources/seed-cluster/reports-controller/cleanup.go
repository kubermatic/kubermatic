...
// ResourcesForDeletion returns a list of resources that should be deleted when the Kyverno reports controller is removed.
func ResourcesForDeletion(cluster *kubermaticv1.Cluster) []ctrlruntimeclient.Object {
	return []ctrlruntimeclient.Object{
		&appsv1.Deployment{
			ObjectMeta: metav1.ObjectMeta{
				Name:      commonseedresources.KyvernoReportsControllerDeploymentName,
				Namespace: cluster.Status.NamespaceName,
			},
		},
		&corev1.Service{
			ObjectMeta: metav1.ObjectMeta{
				Name:      commonseedresources.KyvernoReportsControllerMetricsServiceName,
				Namespace: cluster.Status.NamespaceName,
			},
		},
		&rbacv1.Role{
		...
		&rbacv1.RoleBinding{
			ObjectMeta: metav1.ObjectMeta{
				Name:      commonseedresources.KyvernoReportsControllerRoleBindingName,
				Namespace: cluster.Status.NamespaceName,
			},
		},
