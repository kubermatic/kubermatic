...
// ServiceReconciler returns the function to create and update the Kyverno reports controller service.
func ServiceReconciler(cluster *kubermaticv1.Cluster) reconciling.NamedServiceReconcilerFactory {
	return func() (string, reconciling.ServiceReconciler) {
		return reportsControllerName, func(s *corev1.Service) (*corev1.Service, error) {
...
func MetricsServiceReconciler(cluster *kubermaticv1.Cluster) reconciling.NamedServiceReconcilerFactory {
	return func() (string, reconciling.ServiceReconciler) {
		return reportsControllerName + "-metrics", func(s *corev1.Service) (*corev1.Service, error) {
			s.Labels = map[string]string{
				"app.kubernetes.io/component": "reports-controller",
				"app.kubernetes.io/instance":  "kyverno",
				"app.kubernetes.io/part-of":   "kyverno",
