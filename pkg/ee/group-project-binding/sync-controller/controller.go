...
func (r *reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	groupProjectBindingReconcilerFactorys := []reconciling.NamedKubermaticV1GroupProjectBindingReconcilerFactory{
	...
	err := r.syncAllSeeds(log, groupProjectBinding, func(seedClusterClient ctrlruntimeclient.Client, groupProjectBinding *kubermaticv1.GroupProjectBinding) error {
		return reconciling.ReconcileKubermaticV1GroupProjectBindings(ctx, groupProjectBindingReconcilerFactorys, "", seedClusterClient)
	})
