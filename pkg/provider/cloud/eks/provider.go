...
import (
	...
	"k8c.io/kubermatic/v3/pkg/provider/cloud/eks/authenticator"
...
func ListUpgrades(ctx context.Context,
	...
	masterVersions, err := clusterProvider.VersionsEndpoint(ctx, configGetter, kubermaticv1.ExternalClusterProviderEKS)
	if err != nil {
		return nil, err
	}
