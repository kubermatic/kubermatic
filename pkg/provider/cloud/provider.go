...
import (
	...
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/aws"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/azure"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/bringyourown"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/digitalocean"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/fake"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/gcp"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/hetzner"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/kubevirt"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/openstack"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/packet"
	"github.com/kubermatic/kubermatic/pkg/provider/cloud/vsphere"
)
