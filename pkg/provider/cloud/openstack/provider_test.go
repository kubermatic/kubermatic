...
func TestGetCredentialsForCluster(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			spec:    &kubermaticv1.OpenStackCloudSpec{UseToken: false, CredentialsReference: &kubermaticv1.GlobalSecretKeySelector{ObjectReference: corev1.ObjectReference{Name: "the-secret", Namespace: "default"}, Key: "data"}},
