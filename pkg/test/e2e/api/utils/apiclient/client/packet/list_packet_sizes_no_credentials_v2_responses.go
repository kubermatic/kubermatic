...
/*ListPacketSizesNoCredentialsV2OK handles this case with default header values.
...
/*ListPacketSizesNoCredentialsV2Default handles this case with default header values.
