...
func (m *VirtualMachineInstancePreset) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *VirtualMachineInstancePreset) validateDeletionTimestamp(formats strfmt.Registry) error {
...
func (m *VirtualMachineInstancePreset) validateSpec(formats strfmt.Registry) error {
...
// ContextValidate validate this virtual machine instance preset based on the context it is used
...
func (m *VirtualMachineInstancePreset) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
