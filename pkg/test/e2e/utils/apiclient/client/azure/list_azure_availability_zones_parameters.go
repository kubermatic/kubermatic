...
// WithDefaults hydrates default values in the list azure availability zones params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListAzureAvailabilityZonesParams) WithDefaults() *ListAzureAvailabilityZonesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list azure availability zones params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListAzureAvailabilityZonesParams) SetDefaults() {
