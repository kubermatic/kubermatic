...
// WithRegion adds the region to the list e k s regions params
func (o *ListEKSRegionsParams) WithRegion(region *string) *ListEKSRegionsParams {
	o.SetRegion(region)
	return o
}

// SetRegion adds the region to the list e k s regions params
func (o *ListEKSRegionsParams) SetRegion(region *string) {
	o.Region = region
}
