...
func (o *ListOpenstackNetworksNoCredentialsParams) WithDefaults() *ListOpenstackNetworksNoCredentialsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *ListOpenstackNetworksNoCredentialsParams) SetDefaults() {
