...
func (o *ListOpenstackNetworksParams) WithDefaults() *ListOpenstackNetworksParams {
	o.SetDefaults()
	return o
}
...
func (o *ListOpenstackNetworksParams) WithProject(project *string) *ListOpenstackNetworksParams {
