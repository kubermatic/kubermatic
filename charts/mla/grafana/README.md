...
| `serviceMonitor.interval`                 | How frequently Prometheus should scrape. Unset by default, which inherits the Prometheus global scrape interval | `""`                                                                                            |
| `serviceMonitor.path`                     | Path to scrape                                | `/metrics`                                                                                                                       |
| `serviceMonitor.scheme`                   | Scheme to use for metrics scraping            | `http`                                                                                                                           |
| `serviceMonitor.tlsConfig`                | TLS configuration block for the endpoint      | `{}`                                                                                                                             |
| `serviceMonitor.labels`                   | Labels for the servicemonitor passed to Prometheus Operator      | `{}`                                                                                                                             |
| `serviceMonitor.scrapeTimeout`            | Timeout after which the scrape is ended. Unset by default, which inherits the Prometheus global scrape timeout | `""`                                                                                              |
