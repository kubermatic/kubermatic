...
func main() {
	...
	flag.StringVar(&runOp.addonsList, "addons-list", "canal,dashboard,dns,heapster,kube-proxy,openvpn,rbac,kubelet-configmap,default-storage-class,metrics-server", "Comma separated list of Addons to install into every user-cluster")
