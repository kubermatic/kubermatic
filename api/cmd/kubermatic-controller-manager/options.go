...
func newControllerRunOptions() (controllerRunOptions, error) {
	...
	flag.BoolVar(&c.apiServerEndpointReconcilingDisabled, "apiserver-endpoint-reconciling-disabled", false, "Whether to disable reconciling for the apiserver endpoints by default")
