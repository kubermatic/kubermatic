...
func newControllerRunOptions() (controllerRunOptions, error) {
	...
	flag.StringVar(&c.openshiftAddonsList, "openshift-addons-list", "networking,openvpn,rbac,crd", "Comma separated list of addons to install into every openshift user cluster")
