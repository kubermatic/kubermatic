...
func newControllerRunOptions() (controllerRunOptions, error) {
	...
	flag.BoolVar(&c.apiServerEndpointReconcilingDisabled, "apiserver-endpoint-reconciling-disabled", false, "Whether to disable endpoint reconciling for the apiserver")
