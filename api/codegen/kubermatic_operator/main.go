...
func main() {
	...
	writeYAML(common.DefaultVersionsYAML, "config/kubermatic/static/master/versions.yaml")
	writeYAML(common.DefaultUpdatesYAML, "config/kubermatic/static/master/updates.yaml")
