...
func (cc *Controller) ensureRoles(c *kubermaticv1.Cluster) error {
	roles := map[string]func(data *resources.TemplateData, app, masterResourcesPath string) (*rbacv1beta1.Role, string, error){
...
func (cc *Controller) ensureRoleBindings(c *kubermaticv1.Cluster) error {
	roleBindings := map[string]func(data *resources.TemplateData, app, masterResourcesPath string) (*rbacv1beta1.RoleBinding, string, error){
...
func (cc *Controller) ensureClusterRoleBindings(c *kubermaticv1.Cluster) error {
	clusterRoleBindings := map[string]func(data *resources.TemplateData, app, masterResourcesPath string) (*rbacv1beta1.ClusterRoleBinding, string, error){
