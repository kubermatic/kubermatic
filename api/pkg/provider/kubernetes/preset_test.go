...
func TestGetPreset(t *testing.T) {
	...
	testcases := []struct {
		...
		manager       *kubernetesprovider.PresetsProvider
	...
	}{
		{
			...
			presetName: "test-3",
			manager: kubernetesprovider.NewWithPresetsProvider(&kubermaticv1.PresetList{
		...
		{
			name:       "test 2: get Preset for the rest of the users",
			userInfo:   provider.UserInfo{Email: "test@example.com"},
			presetName: "test-1",
			manager: kubernetesprovider.NewWithPresetsProvider(&kubermaticv1.PresetList{
				Items: []kubermaticv1.Preset{
