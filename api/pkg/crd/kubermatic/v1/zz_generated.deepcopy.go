...
func (cs *ClusterStatus) DeepCopyInto(out *ClusterStatus) {
	*out = *cs
	cs.LastUpdated.DeepCopyInto(&out.LastUpdated)
	out.ExtendedHealth = cs.ExtendedHealth
	if cs.RootCA != nil {
		in, out := &cs.RootCA, &out.RootCA
		*out = new(KeyCert)
		(*in).DeepCopyInto(*out)
	}
	if cs.ApiserverCert != nil {
		in, out := &cs.ApiserverCert, &out.ApiserverCert
		*out = new(KeyCert)
		(*in).DeepCopyInto(*out)
	}
	if cs.KubeletCert != nil {
		in, out := &cs.KubeletCert, &out.KubeletCert
		*out = new(KeyCert)
		(*in).DeepCopyInto(*out)
	}
	if cs.ApiserverSSHKey != nil {
		in, out := &cs.ApiserverSSHKey, &out.ApiserverSSHKey
		*out = new(RSAKeys)
		(*in).DeepCopyInto(*out)
	}
	if cs.ServiceAccountKey != nil {
		in, out := &cs.ServiceAccountKey, &out.ServiceAccountKey
		*out = make(Bytes, len(*in))
		copy(*out, *in)
	}
	if cs.ErrorReason != nil {
		in, out := &cs.ErrorReason, &out.ErrorReason
		*out = new(ClusterStatusError)
		**out = **in
	}
	if cs.ErrorMessage != nil {
		in, out := &cs.ErrorMessage, &out.ErrorMessage
		*out = new(string)
		**out = **in
	}
	if cs.Conditions != nil {
		in, out := &cs.Conditions, &out.Conditions
...
func (cs *ClusterStatus) DeepCopy() *ClusterStatus {
	if cs == nil {
		return nil
	}
