...
type AddonInterface interface {
	Create(*v1alpha1.Addon) (*v1alpha1.Addon, error)
	Update(*v1alpha1.Addon) (*v1alpha1.Addon, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Addon, error)
	List(opts v1.ListOptions) (*v1alpha1.AddonList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Addon, err error)
	AddonExpansion
}
...
func newAddons(c *AddonsV1alpha1Client) *addons {
	return &addons{
		client: c.RESTClient(),
	}
}
...
func (c *addons) Get(name string, options v1.GetOptions) (result *v1alpha1.Addon, err error) {
...
func (c *addons) List(opts v1.ListOptions) (result *v1alpha1.AddonList, err error) {
...
func (c *addons) Watch(opts v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("addons").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *addons) Create(addon *v1alpha1.Addon) (result *v1alpha1.Addon, err error) {
	result = &v1alpha1.Addon{}
	err = c.client.Post().
		Resource("addons").
		Body(addon).
...
func (c *addons) Update(addon *v1alpha1.Addon) (result *v1alpha1.Addon, err error) {
	result = &v1alpha1.Addon{}
	err = c.client.Put().
		Resource("addons").
		Name(addon.Name).
...
func (c *addons) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *addons) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	return c.client.Delete().
		Resource("addons").
...
func (c *addons) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Addon, err error) {
	result = &v1alpha1.Addon{}
