...
type FakeEtcdClusters struct {
	Fake *FakeEtcdoperatorV1beta2
	ns   string
}

var etcdclustersResource = schema.GroupVersionResource{Group: "etcdoperator", Version: "v1beta2", Resource: "etcdclusters"}

var etcdclustersKind = schema.GroupVersionKind{Group: "etcdoperator", Version: "v1beta2", Kind: "EtcdCluster"}
