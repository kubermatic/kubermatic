...
func (o *ListSystemLabelsOK) Error() string {
	return fmt.Sprintf("[PATCH /api/v1/label/system][%d] listSystemLabelsOK  %+v", 200, o.Payload)
}
...
func (o *ListSystemLabelsUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /api/v1/label/system][%d] listSystemLabelsUnauthorized ", 401)
}
...
func (o *ListSystemLabelsForbidden) Error() string {
	return fmt.Sprintf("[PATCH /api/v1/label/system][%d] listSystemLabelsForbidden ", 403)
}
...
func (o *ListSystemLabelsDefault) Error() string {
	return fmt.Sprintf("[PATCH /api/v1/label/system][%d] listSystemLabels default  %+v", o._statusCode, o.Payload)
}
