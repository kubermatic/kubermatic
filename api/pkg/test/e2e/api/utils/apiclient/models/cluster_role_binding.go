...
func (m *ClusterRoleBinding) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *ClusterRoleBinding) validateDeletionTimestamp(formats strfmt.Registry) error {
