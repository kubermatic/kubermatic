...
// NewSemver creates new Semver version sturct and returns pointer to it.
...
// set initializes semver sturct and sets version.
...
// Semver returns library semver sturct.
...
// DeepCopy copies value of Semver struct and returns a new sturct.
