...
func TestDatacentersEndpoint(t *testing.T) {
	...
	compareWithResult(t, res, "[{\"metadata\":{\"name\":\"regular-do1\",\"resourceVersion\":\"1\"},\"spec\":{\"country\":\"NL\",\"location\":\"Amsterdam\",\"sshKeyProvider\":\"digitalocean\",\"digitalocean\":{\"region\":\"ams2\"}}},{\"metadata\":{\"name\":\"us-central1\",\"resourceVersion\":\"1\"},\"spec\":{\"country\":\"US\",\"location\":\"us-central\",\"sshKeyProvider\":\"digitalocean\",\"digitalocean\":{\"region\":\"ams2\"}},\"seed\":true}]")
}
...
func TestDatacenterEndpointAdmin(t *testing.T) {
	...
	compareWithResult(t, res, "{\"metadata\":{\"name\":\"private-do1\",\"resourceVersion\":\"1\"},\"spec\":{\"country\":\"NL\",\"location\":\"US \",\"sshKeyProvider\":\"digitalocean\",\"digitalocean\":{\"region\":\"ams2\"}}}")
...
func TestDatacenterEndpointFound(t *testing.T) {
	...
	compareWithResult(t, res, "{\"metadata\":{\"name\":\"regular-do1\",\"resourceVersion\":\"1\"},\"spec\":{\"country\":\"NL\",\"location\":\"Amsterdam\",\"sshKeyProvider\":\"digitalocean\",\"digitalocean\":{\"region\":\"ams2\"}}}")
}
