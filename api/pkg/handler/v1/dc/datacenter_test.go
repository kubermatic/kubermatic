...
func TestDatacenterEndpointFilteredByEmail(t *testing.T) {
...

	{
		...
		test.CompareWithResult(t, res, `{"metadata":{"name":"restricted-fake-dc","resourceVersion":"1"},"spec":{"seed":"us-central1","country":"NL","location":"Amsterdam","provider":"fake","requiredEmailDomain":"example.com","enforceAuditLogging":false,"enforcePodSecurityPolicy":false}}`)
	}
}
...
func TestDatacenterEndpointAdmin(t *testing.T) {
	...
	test.CompareWithResult(t, res, `{"metadata":{"name":"private-do1","resourceVersion":"1"},"spec":{"seed":"us-central1","country":"NL","location":"US ","provider":"digitalocean","digitalocean":{"region":"ams2"},"enforceAuditLogging":false,"enforcePodSecurityPolicy":false}}`)
...
func TestDatacenterEndpointFound(t *testing.T) {
	...
	test.CompareWithResult(t, res, `{"metadata":{"name":"regular-do1","resourceVersion":"1"},"spec":{"seed":"us-central1","country":"NL","location":"Amsterdam","provider":"digitalocean","digitalocean":{"region":"ams2"},"enforceAuditLogging":false,"enforcePodSecurityPolicy":false}}`)
}
