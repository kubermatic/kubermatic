	...
	for _, tc := range testcases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			expectedResponse := tc.ExpectedResponse
			{
				...
				expectedResponse = fmt.Sprintf(tc.ExpectedResponse, actualSSHKey.Name)
			}
