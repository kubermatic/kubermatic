...
var machinesResource = schema.GroupVersionResource{Group: "machine.k8s.io", Version: "v1alpha1", Resource: "machines"}

var machinesKind = schema.GroupVersionKind{Group: "machine.k8s.io", Version: "v1alpha1", Kind: "Machine"}
