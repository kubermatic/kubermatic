...
# always tar'ing and then converting to zip as required
...
echodate "Uploading CE archive..."

archive="kubermatic-ce-$RELEASE_NAME.tar.gz"
# GNU tar is required
tar czf "$archive" \
