...
- Add `enable` &amp; `enforce` OPA options to Admin Settings [#6787](https://github.com/kubermatic/kubermatic/issues/6787)
...
- Redesigne manage SSH keys dialog on cluster details to improve user experience. [#3120](https://github.com/kubermatic/dashboard/issues/3120) 
...
- Add `enable` &amp; `enforce` OPA options to Admin Settings [#3206](https://github.com/kubermatic/dashboard/issues/3206)
