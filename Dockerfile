...
# policy.
ADD https://dl.k8s.io/v1.37.0/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.37
ADD https://dl.k8s.io/v1.36.2/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.36
