...
# policy.
ADD https://dl.k8s.io/v1.30.0/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.30
ADD https://dl.k8s.io/v1.28.9/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.28
