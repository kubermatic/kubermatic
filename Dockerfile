...
# policy.
ADD https://dl.k8s.io/v1.35.5/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.35
ADD https://dl.k8s.io/v1.34.8/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.34
ADD https://dl.k8s.io/v1.33.12/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.33
ADD https://dl.k8s.io/v1.32.13/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.32
