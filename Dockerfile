...
# policy.
ADD https://dl.k8s.io/v1.32.0/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.32
ADD https://dl.k8s.io/v1.30.5/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.30
