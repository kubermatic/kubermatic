...
# policy.
ADD https://storage.googleapis.com/kubernetes-release/release/v1.27.4/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.27
ADD https://storage.googleapis.com/kubernetes-release/release/v1.25.12/bin/linux/amd64/kubectl /usr/local/bin/kubectl-1.25

RUN wget -O- https://get.helm.sh/helm-v3.11.3-linux-amd64.tar.gz | tar xzOf - linux-amd64/helm > /usr/local/bin/helm
