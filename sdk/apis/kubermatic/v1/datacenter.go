...
type KyvernoConfigurations struct {
	...
	// If nil, Kyverno no enforcement preference is declared.
	// For example, if Kyverno is enforced at the Seed level, setting this to false at the Datacenter level make the Datacenter not enforce Kyverno,
