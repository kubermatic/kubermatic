...
type ClusterInterface interface {
	...
	List(kapi.ListOptions) (*ClusterList, error)
	Watch(kapi.ListOptions) (watch.Interface, error)
...
type NodesInterface interface {
	...
	List(kapi.ListOptions) (*NodeList, error)
...
func (c *NodesClient) List(opts kapi.ListOptions) (result *NodeList, err error) {
	result = &NodeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource(NodeResourceName).
...
func (c *NodesClient) Watch(opts kapi.ListOptions) (watch.Interface, error) {
	return c.client.Get().
		Namespace(c.ns).
		Prefix("watch").
		Resource(NodeResourceName).
...
func (c *ClusterClient) List(opts kapi.ListOptions) (result *ClusterList, err error) {
	result = &ClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource(ClusterResourceName).
...
func (c *ClusterClient) Watch(opts kapi.ListOptions) (watch.Interface, error) {
	return c.client.Get().
		Namespace(c.ns).
		Prefix("watch").
		Resource(ClusterResourceName).
